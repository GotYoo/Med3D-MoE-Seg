...
# 别名兼容（项目使用 MedPLib 命名）
MedPLibMoELlamaConfig = MedPLIBMoELlamaConfig
MedPLibMoELlamaModel = MedPLIBMoELlamaModel  
MedPLibMoELlamaForCausalLM = MedPLIBMoELlamaForCausalLM
